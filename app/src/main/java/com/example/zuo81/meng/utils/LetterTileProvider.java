...
public class LetterTileProvider {
    ...
    /**
     * @param key The KEY_REALM_DB_NAME used to generate the tile color
     * @return A new or previously chosen color for <code>KEY_REALM_DB_NAME</code> used as the
     *         tile background color
     */
    private int pickColor(String key) {
        // String.hashCode() is not supposed to change across java versions, so
        // this should guarantee the same KEY_REALM_DB_NAME always maps to the same color
